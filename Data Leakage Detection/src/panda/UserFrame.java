...
public class UserFrame extends javax.swing.JFrame {
    ...
    public final void showGroupMembers()
    {
        ...
        try
        {
            ResultSet rs1=st.executeQuery("select * from UserRegister where GroupNo='"+groupno+"' and  CloudId='"+cloudid+"'");
            while(rs1.next())
            {
            ...
            ResultSet rs2=st.executeQuery("select * from RevockedUser where BlockedBy='"+name+"' and CloudId='"+cloudid+"'");
            while(rs2.next())
            {
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jButton23, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGap(92, 92, 92)
	...
	System.out.println("Key size: "+n.bitLength());
        ...
        try
        {            
            ResultSet rs=st.executeQuery("select * from KeyDetails where FileName='"+filename+"' and CloudId='"+cloudid+"'");
            if(rs.next())
            {
            ...
            {
                st.executeUpdate("insert into KeyDetails values('"+filename+"','"+pubkeys+"','"+privkeys+"','"+name+"','"+groupno+"','"+cloudid+"')");
            }
        }
        catch(Exception e1)
        {
        ...
        JOptionPane.showMessageDialog(new JFrame(), "Keys are Generated & forward to its group members and public verifier Successfully!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
		...
		String sign=sg.calculateRFC2104HMAC(str1,"key");
                ...
                try
                {            
                    ResultSet rs=st.executeQuery("select * from UploadDetails where BlockName='"+blockname+"' and CloudId='"+cloudid+"'");
                    if(rs.next())
                    {
                    ...
                    {
                        st.executeUpdate("insert into UploadDetails values('"+name+"','"+groupno+"','"+filename+"','"+blockname+"','"+cipfile+"','"+sign+"','"+cloudid+"')");
                        au++;
                    }
                }
                catch(Exception e1)
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        {            
            int count=0;
            String disp="";
            ResultSet rs=st.executeQuery("select * from UploadDetails where FileName='"+filena+"' and CloudId='"+cloudid+"'");
            while(rs.next())
            {
                count=1;
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try
        {                           
            ResultSet rs=st.executeQuery("select * from KeyDetails where FileName='"+fn3+"' and GroupNo='"+groupno+"' and CloudId='"+cloudid+"'");
            if(rs.next())
            {
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try
        {
            ResultSet rs=st.executeQuery("select * from UploadDetails where FileName='"+fn3+"' and CloudId='"+cloudid+"'");
            while(rs.next())
            {                
                String name1=rs.getString(1);
                String groupno1=rs.getString(2);
        ...
        catch(Exception e)
        {
            ...
            try
            {               
                ResultSet rs1=st.executeQuery("select * from UserRegister where GroupNo='"+groupno+"' and UserType='"+"Original User"+"' and CloudId='"+cloudid+"'");
                String groupowner="";
                if(rs1.next())
                {
                    String name1=rs1.getString(3);
                ...
                ResultSet rs=st.executeQuery("select * from RevockedUser where UserName='"+name+"' and CloudId='"+cloudid+"'");
                if(rs.next())
                {
                ...
                {
                    st.executeUpdate("insert into RevockedUser values('"+name+"','"+priv+"','"+groupowner+"','"+cloudid+"')");
                }
            }
            catch(Exception e1)
            {
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        ...
        {            
            ...
            ResultSet rs=st.executeQuery("select * from UserRegister where GroupNo='"+groupid+"' and CloudId='"+cid+"'");
            while(rs.next())
            {
	...
	System.out.println("Key size: "+n.bitLength());
        ...
        try
        {            
            ResultSet rs=st.executeQuery("select * from SharingKeyDetails where FileName='"+filename+"' and OwnerName='"+name+"' and GroupNo='"+groupno+"' and CloudId='"+cloudid+"' and DestinationCloudId='"+cid+"' and DestinationGroupNo='"+groupid+"' and DestimemberName='"+membname+"'");
            if(rs.next())
            {
            ...
            {
                st.executeUpdate("insert into SharingKeyDetails values('"+filename+"','"+pubkeys+"','"+privkeys+"','"+name+"','"+groupno+"','"+cloudid+"','"+cid+"','"+groupid+"','"+membname+"')");
            }
        }
        catch(Exception e1)
        {
        ...
        JOptionPane.showMessageDialog(new JFrame(), "Keys are Generated & forward to "+membname+" and public verifier Successfully!");    
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
		...
		String sign=sg.calculateRFC2104HMAC(str1,"key");
                ...
                try
                {            
                    ResultSet rs=st.executeQuery("select * from SharingUploadDetails where BlockName='"+blockname+"' and CloudId='"+cloudid+"'");
                    if(rs.next())
                    {
                        JOptionPane.showMessageDialog(new JFrame(), "This block is already exists!");
                    }
                    ...
                    {
                        st.executeUpdate("insert into SharingUploadDetails values('"+name+"','"+groupno+"','"+filename+"','"+blockname+"','"+cipfile+"','"+sign+"','"+cloudid+"','"+cid+"','"+groupid+"','"+membname+"')");
                        au++;
                    }
                }
                catch(Exception e1)
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        {            
            int count=0;
            String disp="";
            ResultSet rs=st.executeQuery("select * from SharingUploadDetails where FileName='"+filena+"' and DestinationCloudId='"+cloudid+"' and DestinationGroupNo='"+groupno+"'");
            while(rs.next())
            {
                count=1;
                String name1=rs.getString(1);
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        try
        {                           
            ResultSet rs=st.executeQuery("select * from SharingKeyDetails where FileName='"+fn3+"' and DestinationGroupNo='"+groupno+"' and DestinationCloudId='"+cloudid+"' and DestimemberName='"+name+"'");
            if(rs.next())
            {
                String fne=rs.getString(1); //filename
                String pub=rs.getString(2);
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        if(attacker==1)
        {
            ...
            try
            {               
                ResultSet rs1=st.executeQuery("select * from UserRegister where GroupNo='"+gd+"' and UserType='"+"Original User"+"' and CloudId='"+cd+"'");
                String groupowner="";
                if(rs1.next())
                {
                    String name1=rs1.getString(3);
                ...
                ResultSet rs=st.executeQuery("select * from RevockedUser where UserName='"+name+"' and CloudId='"+cd+"'");
                if(rs.next())
                {
                ...
                {
                    st.executeUpdate("insert into RevockedUser values('"+name+"','"+priv+"','"+groupowner+"','"+cd+"')");
                }
            }
            catch(Exception e1)
            {
        ...
        else
        {
            ...
            try
            {
                ResultSet rs=st.executeQuery("select * from SharingUploadDetails where FileName='"+fn3+"' and DestinationCloudId='"+cloudid+"' and DestinationGroupNo='"+groupno+"' and DestimemberName='"+name+"'");
                while(rs.next())
                {                
                    String name1=rs.getString(1);
                    String groupno1=rs.getString(2);
    ...
    private void split(String pa) {
		...
		// Reading file and getting no. of files to be generated 
            ...
            String s=JOptionPane.showInputDialog(new JFrame(),"Enter the Number of files to be generated:");//  No. of lines to be split and saved in each output file.  
            ...
            {
                JOptionPane.showMessageDialog(new JFrame(),"No of Lines in the file "+count+" So don't ask for too much!");
            }
        }
        catch (Exception e)  
        {  
